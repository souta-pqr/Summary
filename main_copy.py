...
# OpenAIのAPIキーを設定します。
openai.api_key = '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'
...
# 音声合成を実行します。
command = 'curl -s -H "Content-Type: application/json" -X POST -d @query.json "127.0.0.1:50021/synthesis?speaker=1" > audio.wav'
